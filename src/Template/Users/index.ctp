    ...
    <table cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                ...
                <th scope="col"><?= $this->Paginator->sort('tckn') ?></th>
                <th scope="col"><?= $this->Paginator->sort('personnelno') ?></th>
                <th scope="col"><?= $this->Paginator->sort('address') ?></th>
                <th scope="col"><?= $this->Paginator->sort('permitleft') ?></th>
                <th scope="col"><?= $this->Paginator->sort('permitused') ?></th>
